...
public class CommonUtilities {
	...
	public void waitForElementToBeVisible(By locator) {
		try {
			...
			wait.until(ExpectedConditions.visibilityOfElementLocated(locator));//implicitwait
	...
	public void waitForElementToBeClickable(By locator) {
		try {
			wait = new WebDriverWait(driver, 
					Duration.ofSeconds(Long.parseLong(Hooks.configData.getProperty("wait.duration"))));
			wait.until(ExpectedConditions.elementToBeClickable(locator));//implicitwait
		} catch (NumberFormatException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public static void captureScreenshot() {
		...
		File scrFile = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE); //pre-defind for
																					//capture screenshot
